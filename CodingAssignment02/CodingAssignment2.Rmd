...
With the variables Age, BMI, Smoker and WinterPark testing significant at the 95% level, we can say that the variables have a statistically significant effect on the dependent variable, the Total medical expenses for a particular insurance plan (in dollars). The coefficients for the statistically significant variables show the change in Total medical expenses for a particular insurance plan (in dollars) for every change in their respective 1 unit. For example, the total medical expenses for a particular insurance plan increases by ~$282 for every 1 year older the primary beneficiary is. Additionally, the positive and negative signs that proceed each coefficient indicate the direct and indirect relationship that each variable has with the dependent variable. For example, looking at the Age variable again, it has a positive sign before the coefficient, indicating a direct relationship.  
...
```
Predicted amount of medical expense associated with this policy is 4122, give or take 1737.    
